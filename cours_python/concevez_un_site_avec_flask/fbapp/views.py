...
from .utils import find_random_content_by_gender, OpenGraphImage
...
def index():
    ...
    description = """
        Toi, tu sais comment utiliser la console ! Jamais à court d'idées pour réaliser ton objectif, tu es déterminé-e 
        et persévérant-e. Tes amis disent d'ailleurs volontiers que tu as du caractère et que tu ne te laisses pas 
        marcher sur les pieds. Un peu hacker sur les bords, tu aimes trouver des solutions à tout problème. 
...
def result():
    ...
    description = find_random_content_by_gender(gender).description
