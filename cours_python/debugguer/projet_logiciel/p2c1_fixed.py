...
from tkinter import PhotoImage, Tk, Label, Button, constants
...
bouton_recommencer.grid(row=5, column=0, pady=10, sticky=constants.E)

bouton_quitter = Button(fenetre, text='Quitter', command=quit, font=("Courier", 20, "bold"))
bouton_quitter.grid(row=5, column=2, pady=10, sticky=constants.W)
